...
- Use collision-resistant versioned directory/workspace markers, conservatively
  migrate owned legacy comments, and warn about duplicates without deleting them
...
[Unreleased]: https://github.com/thekbb/terraform-plan-commenter-action/compare/v2.1.1...HEAD
[2.1.1]: https://github.com/thekbb/terraform-plan-commenter-action/compare/v2.1.0...v2.1.1
[2.1.0]: https://github.com/thekbb/terraform-plan-commenter-action/compare/v2.0.0...v2.1.0
